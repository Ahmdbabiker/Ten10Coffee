...
urlpatterns = [
    ...
    path('admin_dashboard/manage_products/edit/<int:product_id>' , edit_product , name="edit_product"),
    path('admin_dashboard/manage_products/add_product' , add_product , name="add_product"),
